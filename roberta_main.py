...
output_roberta_list = roberta.roberta_detect(homoglyph_dataset, START_INDEX, END_INDEX)
out_file_name = "result/roberta_homoglyph_" + str(START_INDEX) + "-" + str(END_INDEX-1) + ".json"
out_file = open(out_file_name, "w")
json.dump(output_roberta_list, out_file)
out_file.close()
