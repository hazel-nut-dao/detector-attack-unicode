...
output_deepfake_list = roberta.roberta_detect(homoglyph_dataset, START_INDEX, END_INDEX)
out_file_name = "result/roberta_homoglyph_" + str(threshold) + "_" + str(START_INDEX) + "-" + str(END_INDEX-1) + ".json"
...
results = []
result_file_list = [filename for filename in os.listdir(folder) if filename.startswith('roberta_homoglyph_'+ str(threshold))]
